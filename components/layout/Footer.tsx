    ...
    <footer className="bg-white border-t border-gray-200">
      ...
      <div className="container-padding max-w-7xl mx-auto py-12">
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-8">
          {/* Logo & Info - UPDATED with new company info */}
          <div className="col-span-2 lg:col-span-1">
            <Link href="/" className="flex items-center space-x-3 mb-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-slate-500 -mt-1">Diagnostics Ltd.</span>
              </div>
            </Link>
            <p className="text-sm text-slate-600 mb-4">
              Your trusted partner in diagnostic and medical equipment since 2020. 
              FDA-approved, certified, and delivered with care across Uganda.
            </p>
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex flex-col">
                  <a href={`tel:${COMPANY_INFO.phone1}`} className="text-slate-600 hover:text-medical-blue">
                    {COMPANY_INFO.phone1}
                  </a>
                  <a href={`tel:${COMPANY_INFO.phone2}`} className="text-slate-600 hover:text-medical-blue">
                    {COMPANY_INFO.phone2}
                  </a>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <a href={`mailto:${COMPANY_INFO.email}`} className="text-slate-600 hover:text-medical-blue break-all">
                  {COMPANY_INFO.email}
                </a>
              </div>
            </div>
        ...
        {/* Bottom Bar - UPDATED with new company info and social links */}
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-slate-500">
              © {currentYear} {COMPANY_INFO.name}. Kampala, Uganda.
            </p>
