...
export default function ContactPage() {
  ...
  // Contact info with YOUR Uganda contact information
  const contactInfo = [
    {
      icon: PhoneIcon,
      title: 'Phone',
      content: COMPANY_INFO.phone1,
      subcontent: 'Mon-Fri, 8am-8pm EAT',
      action: `tel:${COMPANY_INFO.phone1}`,
      secondary: COMPANY_INFO.phone2,
      secondaryAction: `tel:${COMPANY_INFO.phone2}`,
    },
    {
      icon: EnvelopeIcon,
      title: 'Email',
    ...
    },
    {
      ...
      subcontent: COMPANY_INFO.fullAddress,
          ...
          <div className="container-padding max-w-7xl mx-auto">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6">
                Contact{' '}
                <span className="text-medical-blue">{COMPANY_INFO.shortName}</span>
              </h1>
              <p className="text-lg text-slate-600 mb-8">
                Have questions about our products, need technical support, or ready to place a bulk order? 
                Our diagnostic equipment specialists are available 24/7.
              </p>
            </div>
          </div>
        </section>
                ...
                {isSubmitted ? (
                  <div className="bg-green-50 border border-green-200 rounded-xl p-8 text-center">
                    ...
                    <p className="text-slate-600">
                      Thank you for contacting {COMPANY_INFO.name}. We'll get back to you within 24 hours.
                    </p>
                  </div>
                ) : (
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg 
                                   focus:outline-none focus:ring-2 focus:ring-medical-blue focus:border-transparent"
                          placeholder={COMPANY_INFO.phone1}
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-2xl shadow-sm p-8">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-slate-900 font-medium">{COMPANY_INFO.name}</p>
                      <p className="text-slate-600">{COMPANY_INFO.location}</p>
                      <p className="text-slate-600">{COMPANY_INFO.fullAddress}</p>
                      <Link 
